...
# initialize figure
fig, axs = plt2.subplots(nrows=2, ncols=len(os.listdir(folder_path)), figsize=(16,8))
...
# adjust spacing
plt2.subplots_adjust(wspace=0.5, hspace=0.425)

# display plot
plt2.show()

#store the figures in the folder Grobid_out 
plt2.savefig('/home/alejandro/Desktop/IA-OpenData/-Artificial-Intelligence-And-Open-Science-In-Research-Software-Engineering/Grobid_out/figure_analysis2.png')

#call the file figure_analysis2.py 
import figure_analysis2